package com.mphasis.bookstoreapp.controller;
...
import com.mphasis.bookstoreapp.exception.BookNotFoundException;
import com.mphasis.bookstoreapp.model.Book;
import com.mphasis.bookstoreapp.service.BookServiceImpl;
...
public class BookController {
	...
	@GetMapping(path = "/books/search/id/{book_id}", produces = { MediaType.APPLICATION_JSON_VALUE })
	...
	@GetMapping(path = "/books/search/title/{book_title}", produces = { MediaType.APPLICATION_JSON_VALUE })
